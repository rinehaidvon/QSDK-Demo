...
typedef enum icalvalue_kind {
   ICAL_ANY_VALUE=5000,
    ICAL_REQUESTSTATUS_VALUE=5001,
    ICAL_GEO_VALUE=5002,
    ICAL_CARLEVEL_VALUE=5003,
    ICAL_TEXT_VALUE=5004,
    ICAL_METHOD_VALUE=5005,
    ICAL_TRIGGER_VALUE=5006,
    ICAL_XLICCLASS_VALUE=5007,
    ICAL_DATE_VALUE=5008,
    ICAL_FLOAT_VALUE=5009,
    ICAL_RECUR_VALUE=5010,
    ICAL_QUERYLEVEL_VALUE=5011,
    ICAL_X_VALUE=5012,
    ICAL_CLASS_VALUE=5013,
    ICAL_URI_VALUE=5014,
    ICAL_CMD_VALUE=5015,
    ...
    ICAL_DATETIMEPERIOD_VALUE=5027,
